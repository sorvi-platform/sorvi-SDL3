...
extern const char SDL_SORVI_app_id[] = "org.sorvi.port.sdl3.primitives";
extern const char SDL_SORVI_app_name[] = "primitives";
extern const char SDL_SORVI_app_version[] = "0.0.0";
